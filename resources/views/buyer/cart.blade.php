                ...
                @foreach($cart as $id => $details)
                    <tr>
                        <td class="product-thumbnail">
                            <img src="{{ asset('storage/images/' . $details['image']) }}" alt="Image" class="img-fluid">
                        </td>
                        ...
                        <td>
                            <!-- Remove Button -->
                            <a href="{{ route('cart.remove', $id) }}" class="btn btn-black btn-sm">X</a>
                        </td>
                    </tr>
                @endforeach
            @else
    ...
    <div class="col-md-6 pl-5">
      <div class="row justify-content-end">
        ...
        <div class="row mb-5">
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-black btn-lg py-3 btn-block" onclick="window.location='{{route('buyer.checkout')}}'">Proceed To Checkout</button>
            </div>
          </div>
        </div>
      </div>
